...
export const stageList: LessonStageMeta[] = [
  {
    ...
    headline: '一条直接规则，真的能分开这些落点吗？',
    description:
      '这里不是完整的飞行物理仿真，而是一个二维落点安全决策模拟。我们先从最简单的网络开始：只有输入层和输出层，没有隐藏层。',
  },
  {
    id: 'io',
    stepNumber: 2,
    ...
    titleZh: '输入与输出',
    shortHint: '观察一个位置如何进入网络，再变成最终判断。',
    headline: '输入描述位置，输出给出判断。',
    description:
      '输入层只负责把当前落点的坐标送进网络，输出层只负责把内部计算汇总成“可安全降落”或“不安全”的结论。',
  },
  {
    id: 'hidden',
    stepNumber: 3,
    ...
    description:
      '复杂的安全区不必一次性直接解决。网络可以让不同隐藏单元分别表示更简单的边界检测，再把这些中间响应组合起来。',
  },
  {
    id: 'activation',
    stepNumber: 4,
